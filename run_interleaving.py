...
ABLATIONS = [
    ...
    {"key": ["experiment", "pretrained_success_rate"], "vals": [0.0]},#, 0.2, 0.5, 1.0]},
...
RESULTS_FILE_NAME = 'trial_results_interleaving.csv'
...
for ablation, (domain, tasks), seed, granularity, condition in itertools.product(
    ...
    for task in tasks:
        for val in ablation["vals"]:
            ...
            cfg["experiment"]["integration_type"] = "interleaved"
